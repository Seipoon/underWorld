...
public class characterCreatorController {
    ...
    @FXML ToggleButton warriorBtn;
    @FXML ToggleButton mageBtn;
    @FXML ToggleButton thiefBtn;
    ...
    public characterCreatorController(Character instance){
        instance = chara;
    }
    @FXML protected void handleCreateBtn(ActionEvent e)throws IOException, Exception{        
        createSaveFile();
...
//        setClassType();
//        chara.setCharaType(this.getClassType());
//        chara.setCharaName(this.getCharacterName());
        resetSelections();
    }
