...
public class savePointOneController {
    ...
    @FXML
    ImageView imgview;
    private final stageTwoController soc;
    private final Character chara;
    private String newData;

    public savePointOneController() throws IOException {
        soc = new stageTwoController();
    ...
    protected void handleSaveBtn(final ActionEvent event) throws IOException, Exception {
        ...
        if (result.get() == ButtonType.OK) {
            try (PrintWriter pw = new PrintWriter("save.txt")) {
                ...
                underworldapp.UnderWorld.setCurrentStage("stageTwoScene");
                ok.showAndWait();
            }
