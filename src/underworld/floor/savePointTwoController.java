 ...
 * @author Jeffrey Oh
 */
public class savePointTwoController {
    ...
    public savePointTwoController() throws IOException {
    ...
    */
    public String getNewData() {
        newData = chara.getCharaName() + "///" + chara.getAttr().get("Class") + "///" + 2;
        return newData;
    }
    ...
    protected void handleSaveBtn(final ActionEvent event) throws IOException, Exception {
        ...
        alert.setHeaderText("Save Point 2");
        ...
        if (result.get() == ButtonType.OK) {
            try (PrintWriter pw = new PrintWriter("save.txt")) {
                ...
                underworldapp.UnderWorld.setCurrentStage("stageThreeScene");
                ok.showAndWait();
            }
